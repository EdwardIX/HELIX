...
project_name='math_circle_packing_ablation'
...
train_datapath=$(realpath ../../data)/datasets/verl/math_program_grpo/train.parquet
test_datapath=$(realpath ../../data)/datasets/verl/math_program_grpo/test.parquet
...
dynamic_sample_strategy=Random

mkdir -p $project_base_path

PYTHONPATH=../../ python3 -m recipe.algo_grpo.main_grpo \
