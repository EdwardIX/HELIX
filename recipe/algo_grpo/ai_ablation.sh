...
# project_name='ai_bank_marketing_ablation'
project_name='ai_boston_housing_ablation'
...
train_datapath=$(realpath ../../data)/datasets/verl/ai_coding_grpo/train.parquet
test_datapath=$(realpath ../../data)/datasets/verl/ai_coding_grpo/test.parquet
