...
test_frequency=0 # 0 for no validation
...
######### Names and Paths ##########
project_name='comsol_inductor_multicore_evolve'
...
train_datapath=$(realpath ../../data)/datasets/verl/comsol_design/train.parquet
test_datapath=$(realpath ../../data)/datasets/verl/comsol_design/test.parquet
train_files="['$train_datapath']"
test_files="['$test_datapath']"
######### Evolve Algorithm Configuration #########
dynamic_prompt_sampler_code_format=yaml # or java
...
PYTHONPATH=$python_path python3 -m recipe.algo_evolve.main_evolve \
    ...
    +data.custom_cls.init_kwargs.language=$dynamic_prompt_sampler_code_format \
    ...
    +data.dynamic_prompt_sampler.code_format=$dynamic_prompt_sampler_code_format \
    ...
    +data.dynamic_sample_strategy.nsga_config.embedding_module=YamlEmbeddingModule \
