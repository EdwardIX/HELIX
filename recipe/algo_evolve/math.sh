...
######### Names and Paths ##########
project_name='math_minimize_func_evolve'
# project_name='math_circle_packing_evolve'
...
train_datapath=$(realpath ../../data)/datasets/verl/math_program/train.parquet
test_datapath=$(realpath ../../data)/datasets/verl/math_program/test.parquet
